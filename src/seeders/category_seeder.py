...
async def seed():
    ...
    await ASyncORM.upsert_items(main_categories, CategoryOrm)

    categories = await ASyncORM.query_items(CategoryOrm)
    ...
    await ASyncORM.upsert_items(sub_categories, CategoryOrm)
